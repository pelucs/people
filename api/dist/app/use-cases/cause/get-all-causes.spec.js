...
// test/in-memory-cause-repositories.ts
var InMemoryCauseRepositories = class {
  constructor() {
    this.causes = [];
  }
...
// src/app/use-cases/cause/get-all-causes.spec.ts
describe("Get all causes", () => {
  it("should be able to get all causes", async () => {
    ...
    await createCause.execute({
      title: "Doa\xE7\xE3o de um pacote de fraldas",
      description: "Preciso de um pacote de fraldas para meu beb\xEA de 5 meses. Por favor nos ajude!",
      contact: "83 98729-6826",
      email: "pedro@gmail.com",
      location: "Rua Doutor Paulo Roberto Mayer, 556",
      expirationAt: /* @__PURE__ */ new Date("20/08/2024"),
      imagesUrl: ["teste.png"]
    });
    await createCause.execute({
      title: "Doa\xE7\xE3o de um pacote de fraudas",
      description: "Preciso de um pacote de fraudas para meu beb\xEA de 5 meses. Por favor nos ajude!",
      contact: "83 98729-6826",
      email: "pedro@gmail.com",
      location: "Rua Doutor Paulo Roberto Mayer, 556",
      expirationAt: /* @__PURE__ */ new Date("20/08/2024"),
    ...
    globalExpect(causes).toBeTruthy();
    globalExpect(causes).toHaveLength(2);
  });
});
