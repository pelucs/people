...
// src/app/use-cases/cause/update-cause.spec.ts
describe("Update cause", () => {
  it("should be able to update a cause", async () => {
    ...
    await updateCause.execute(cause.id, {
      title: "Doa\xE7\xE3o de uma teclado e mouse"
    });
    globalExpect(repositories.causes[0].title).toEqual("Doa\xE7\xE3o de uma teclado e mouse");
  });
});
