...
var CreateUser = class {
  ...
  async execute(request) {
    const { name, email, password, type: type2 } = request;
...
// test/in-memory-user-repositories.ts
var InMemoryUserRepositories = class {
  constructor() {
    this.users = [];
  }
...
// src/app/use-cases/user/get-user.spec.ts
describe("Get user by id", () => {
  it("should be able to get user by id", async () => {
    ...
    globalExpect(isAlreadyUserById).toBeTruthy();
  });
});
