...
async function causeRoutes(app) {
  ...
  app.get("/causes/public", async (request, reply) => {
    await causeController.allPublicCauses(request, reply);
  });
  app.get("/cause/:causeId", async (request, reply) => {
    await causeController.causeById(request, reply);
  });
  app.put("/cause/:causeId", async (request, reply) => {
    await causeController.save(request, reply);
  });
  app.put("/cause/:causeId/publish", async (request, reply) => {
    await causeController.publish(request, reply);
  });
  app.put("/cause/:causeId/unpublish", async (request, reply) => {
